...
function hitungtotalkalori (lari=0,pushup=0,plank=0){
    ...
    kalimat = "harimau merupakan hewan karnivora"
    let spasidihilang = ''
    ...
    let email = "muhamad.akbariqro@gmail.com"
    let cekvalid = false;
    let addSymbol = false;
    let titik = false
    ...
    let namanilai = [["fauzi", 80], ["muzdalifah", 88], ["valentino", 95], ["lorenzo", 90], ["herman", 75], ["rafiudin", 85], ["mail", 70]];
    let totalnilai = 0
    let Lulus = ''
    let TidakLulus = ''
    let nilaiTerbesar = ''
    ...
    // Buatlah array yang digunakan untuk menyimpan nama mahasiswa
    let namaMahasiswa = ["akbar", "ihsan", "valentino", "lorenzo", "herman", "rafiudin", "mail", "hamilton"]
    let namaAwalHurufA = ''
